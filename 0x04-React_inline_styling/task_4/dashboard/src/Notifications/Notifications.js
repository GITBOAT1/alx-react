...
return (
  <div>
    <div className={css(styles.menuItem, styles.menuStyle)}>Your notifications</div>
      {displayDrawer && (
        <div className={css(styles.notifications)}>
              <button style={{ float: 'right'}} aria-label="Close" onClick={this.handleClick} >
              <div className={css(styles.closeButton,styles.closeButtonHover)} alt="Close"> x </div>
              </button>
